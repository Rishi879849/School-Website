...
export default function AdmissionFormPage() {
  ...
  return (
    <div className="flex-1 max-w-4xl w-full mx-auto px-4 py-12 text-left">
      ...
      {submitted ? (
        <div className="bg-white rounded-[2.5rem] p-12 text-center border border-emerald-500/20 max-w-xl mx-auto space-y-6 shadow-xl animate-fade-in">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#2E1E17]/80">
              The admission request for <strong>{studentName}</strong> has been logged into the school queue.
            </p>
          </div>
          <div className="bg-[#FAF6F0] p-4 rounded-2xl border border-[#2E1E17]/10 text-left text-xs space-y-2">
          ...
          <Link to="/" className="inline-block bg-[#FF733B] hover:bg-[#E6622E] text-white text-xs font-extrabold px-8 py-3 rounded-full transition shadow-md shadow-orange-500/10">
            Return Home
          </Link>
        </div>
      ) : (
        <div className="bg-white rounded-[2.5rem] border border-[#2E1E17]/10 overflow-hidden shadow-xl">
          ...
          <div className="bg-[#2F221E] text-white p-8 md:p-10 relative overflow-hidden">
            ...
            <h2 className="text-2xl md:text-3xl font-normal font-serif mt-1 flex items-center gap-2">
            ...
            <div className="grid grid-cols-4 gap-2 mt-8 text-[10px] font-extrabold uppercase tracking-wider text-center text-gray-500">
              {[
                ...
                <div key={item.step} className="flex flex-col items-center gap-1.5">
                  <div className={`w-6 h-6 rounded-full flex items-center justify-center border text-[10px] transition ${
                    formStep >= item.step 
                  ...
                  <span className={formStep >= item.step ? 'text-white' : 'text-white/40'}>{item.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <form onSubmit={formStep === 4 ? handleSubmit : handleNextStep} className="p-6 md:p-10 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full py-2.5 px-4 rounded-xl border border-gray-300 text-xs text-[#2E1E17] bg-white focus:outline-none focus:border-[#FF733B]"
                    >
                      <option value="Grade 10-A">Grade 10-A (Science/AI track)</option>
                      <option value="Grade 11-A">Grade 11-A (Computational Finance)</option>
                      <option value="Grade 12-A">Grade 12-A (Advanced Sandboxes)</option>
                    </select>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-between items-center pt-6 border-t border-[#2E1E17]/10">
              <button 
                ...
                className={`px-6 py-2.5 rounded-full border text-xs font-bold transition flex items-center gap-1 ${
                  formStep === 1 
                    ...
                    : 'border-[#2E1E17]/20 hover:border-black text-[#2E1E17] bg-white'
                }`}
              >
                Previous
              </button>
              ...
              <button 
                type="submit"
                className="bg-[#FF733B] hover:bg-[#E6622E] text-white text-xs font-extrabold px-8 py-2.5 rounded-full shadow-lg transition flex items-center gap-1 hover:scale-105 active:scale-95 duration-200"
              >
